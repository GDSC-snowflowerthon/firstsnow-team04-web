...
function MailboxNSnowman({ mailboxOpen, snowmantype }) {
  ...
  return isShow ? (
    <div className="App-MailboxNSnowman-container">
      <img
        src={iconMailBoxOpen}
        alt="mailbox open Image"
        className="App-MailboxNSnowman-mail"
      />
      <img
        src={snowmanIcon}
        alt={`snowman ${snowmantype} Image`}
        className="App-MailboxNSnowman-snowman"
      />
    </div>
  ) : (
    <div className="App-MailboxNSnowman-container">
      <img
        src={iconMailBoxClose}
        alt="mailbox close Image"
        className="App-MailboxNSnowman-mail"
      />
      <img
        src={snowmanIcon}
